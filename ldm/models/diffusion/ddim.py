...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, shape, input, uc, guidance_scale=1, mask=None, x0=None):
        ...
        for i, step in enumerate(iterator):
            ...
            img, pred_x0, attns = self.p_sample_ddim(input, index=index, uc=uc, guidance_scale=guidance_scale)
            input["x"] = img 
    ...
    def p_sample_ddim(self, input, index, uc=None, guidance_scale=1):
        ...
        e_t, attns = self.model(input, return_attn=True) 
