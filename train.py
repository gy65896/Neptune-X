...
from ldm.modules.distributed import synchronize
import os 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_out", type=str,  default="ckpt", help="path to OUTPUT")

    parser.add_argument("--name", type=str,  default="train", help="experiment will be stored in OUTPUT_ROOT/name")
    parser.add_argument("--seed", type=int,  default=123, help="used in sampler")
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--yaml_file", type=str,  default="configs/X2Mari.yaml", help="paths to base configs.")
    ...
    parser.add_argument("--official_ckpt_name", type=str,  default="./ckpt/sd1.5_finetuned.ckpt", help="SD ckpt name and it is expected in DATA_ROOT, thus DATA_ROOT/official_ckpt_name must exists")
    ...
    parser.add_argument("--total_iters", type=int,  default=100000, help="")
    parser.add_argument("--save_every_iters", type=int,  default=1000, help="")
