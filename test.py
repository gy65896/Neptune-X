    ...
    def generator(self, batch, batch_here):
        ...
        if self.fp16:
            with torch.cuda.amp.autocast():
                return self._generator_impl(batch, batch_here)
        else:
            return self._generator_impl(batch, batch_here)
    
    def _generator_impl(self, batch, batch_here):
...
if __name__ == "__main__":
    ...
    # data_args
    parser.add_argument("--data_path", type=str,  default="./MGD_test", help="data path")
    parser.add_argument("--out_path", type=str,  default="./results_test", help="output path")
    parser.add_argument("--mode", type=str,  default="val", help="")
    

    parser.add_argument("--rand_seed", type=int,  default=None, help="")
